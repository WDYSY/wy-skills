<!--
  ...
  Crawled: 2026-09-04T14:51:43.048276
  Author: 阳凯
-->

# AI编程能力边界探索：基于 Claude Code 的 Spec Coding 项目实战｜得物技术

> 10 天、2.5 万行代码、2754 次工具调用，基于 Claude Code 的 Spec Coding 实战完成企业级中后台从 0 到 1 搭建。本文复盘「约束 + 示范 + 视觉」三层规范体系，拆解 AI 编程能力边界，重构开发者在 AI 时代的核心竞争力与高效研发范式。

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640.gif)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640.jpg)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_1.jpg)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_1.png)![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_2.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_3.png)

**阶段一：设计阶段**

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_4.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_5.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_6.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_7.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_8.png)

**让 AI 扮演产品经理：**

在 Rules 中植入「首席产品专家」Persona 提示词，将 AI 从工程师的「急于执行」模式切换为产品经理的「先想清楚」模式，与 AI 聊清楚我们想干什么。

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_9.png)

**让 AI 扮演 UI 设计师：**

在 Rules 中定义设计规范，通过对话式生成逐页产出高保真 HTML 文件，而不是源码：

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_10.png)

**让 AI 生成研发可读的 PRD：**

基于产品经理角色，将 HTML 设计稿作为上下文，最后生成精确到组件行为级别的 PRD：

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_11.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_2.jpg)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_12.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_13.png)

其中有一天遇到一个测试环境构建失败的问题，结果过程约 4 小时，7 个会话、15+ 次方案尝试、59 条指令。整个项目单日指令最多的一天，也是 AI 独立解决能力最受限的一天。

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_14.png)![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_15.png)
...
```
第一层：约束层（.claude/rules/）      ← 告诉 AI「禁止什么、必须怎样」第二层：示范层（.claude/code-design/）← 告诉 AI「标准产出长什么样」第三层：视觉层（.claude/ui-design/）  ← 告诉 AI「页面应该长什么样」
```
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_16.png)
...
```
.claude/rules/├── ts.md          # TypeScript 规范（禁止 any、使用可选链等）├── code-names.md  # 命名规范（kebab-case/camelCase/PascalCase）├── comment.md     # 注释规范（JSDoc、@ai-context/@ai-rules 文件头）├── lint.md        # 代码风格（单引号、文件末尾换行）├── style.md       # 样式规范（Tailwind CSS、less 文件）├── pages.md       # 页面目录结构规范（constants/services/hooks/components 分层）└── service.md     # API 接口生成规范（fetch{Name}Api 命名、UniversalResp 泛型）
```
...
```
.claude/code-design/├── pro-table/          # 通用列表页模板（含搜索、分页、批量操作、行操作）├── pro-form/           # 通用表单页模板（含创建/编辑双模式、字段验证）├── editable-pro-table/ # 可编辑表格模板（含行内编辑、添加/保存/删除）├── drawer/             # 抽屉组件模板（含标准打开/关闭逻辑）├── compontent/         # 通用组件模板（含 README、Props 定义、使用示例）└── utils/              # 工具函数模板
```
...
```
.claude/ui-design/├── knowledge-spaces.html  # 知识空间列表页设计稿├── search-strategy.html   # 检索配置页设计稿├── space-detail.html      # 空间详情页设计稿└── xxx设计稿
```
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_17.png)![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_18.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_19.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_20.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_21.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_22.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_23.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_24.png)

**值得期待的方向**

基于本项目的数据和经验，后续在以下方向可作深入探索：

![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_25.png)
...
![](AI编程能力边界探索基于_Claude_Code_的_Spec_Coding_项目实战得物技术_files/640_3.jpg)