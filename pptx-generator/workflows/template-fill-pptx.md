...
```bash
python3 skills/pptx-generator/scripts/project_manager.py init "<project_name>" --format ppt169
python3 skills/pptx-generator/scripts/project_manager.py import-sources "<project_dir>" "<source.pptx>" "<material...>"
```
...
```bash
python3 skills/pptx-generator/scripts/template_fill_pptx.py analyze "<project_dir>/sources/<source.pptx>" -o "<project_dir>/analysis/<stem>.slide_library.json"
```
...
```bash
python3 skills/pptx-generator/scripts/template_fill_pptx.py scaffold "<project_dir>/analysis/<stem>.slide_library.json" -o "<project_dir>/analysis/fill_plan.json" --slides "1,3,4"
```
...
```bash
python3 skills/pptx-generator/scripts/template_fill_pptx.py check-plan "<project_dir>/analysis/<stem>.slide_library.json" "<project_dir>/analysis/fill_plan.json" -o "<project_dir>/analysis/check_report.json"
```
...
```bash
python3 skills/pptx-generator/scripts/template_fill_pptx.py apply "<project_dir>/sources/<source.pptx>" "<project_dir>/analysis/fill_plan.json" -o "<project_dir>/exports/<output.pptx>"
```
...
```bash
python3 skills/pptx-generator/scripts/template_fill_pptx.py validate "<project_dir>"
```
