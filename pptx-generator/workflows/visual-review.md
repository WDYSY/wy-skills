...
python3 skills/pptx-generator/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 skills/pptx-generator/scripts/visual_review.py <project_path>
```
...
- Path to the rubric: `skills/pptx-generator/references/visual-review.md`
