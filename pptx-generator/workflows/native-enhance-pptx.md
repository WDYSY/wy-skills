...
```bash
python3 skills/pptx-generator/scripts/native_enhance_pptx.py init "<source.pptx>" --name "<project_slug>"
```
...
```bash
python3 skills/pptx-generator/scripts/native_enhance_pptx.py plan "<project>"
```
...
```bash
python3 skills/pptx-generator/scripts/native_enhance_pptx.py validate "<project>"
```
...
```bash
python3 skills/pptx-generator/scripts/notes_to_audio.py "<project>" \
...
```bash
python3 skills/pptx-generator/scripts/native_enhance_pptx.py apply "<project>"
```
...
```bash
python3 skills/pptx-generator/scripts/source_to_md/ppt_to_md.py \
