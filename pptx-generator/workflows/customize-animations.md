...
```bash
python3 skills/pptx-generator/scripts/animation_config.py list-groups <project_path>
```
...
```bash
python3 skills/pptx-generator/scripts/animation_config.py scaffold <project_path>
```
...
```bash
python3 skills/pptx-generator/scripts/animation_config.py validate <project_path>
```
