...
5. Run the matching calculator command:
   ...
   python3 skills/pptx-generator/scripts/svg_position_calculator.py calc bar \
   ...
   python3 skills/pptx-generator/scripts/svg_position_calculator.py calc line \
   ...
   python3 skills/pptx-generator/scripts/svg_position_calculator.py calc pie \
   ...
   python3 skills/pptx-generator/scripts/svg_position_calculator.py calc radar \
...
```bash
python3 skills/pptx-generator/scripts/svg_quality_checker.py <project_path>
```
...
```bash
python3 skills/pptx-generator/scripts/total_md_split.py <project_path>
python3 skills/pptx-generator/scripts/finalize_svg.py <project_path>
