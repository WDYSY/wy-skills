...
```bash
python3 skills/pptx-generator/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
python3 skills/pptx-generator/scripts/extract_svg_assets.py "<import_workspace>/svg" --icons-dir "<import_workspace>/icons" --inplace --id-prefix layered --min-decoration-bytes 3000 --clean-stale

# mirror creation path
python3 skills/pptx-generator/scripts/extract_svg_assets.py "<import_workspace>/svg-flat" --icons-dir "<import_workspace>/icons" --inplace --id-prefix flat --min-decoration-bytes 3000 --clean-stale
```
...
```bash
python3 skills/pptx-generator/scripts/extract_svg_assets.py "<svg_analysis_workspace>/svg" --icons-dir "<svg_analysis_workspace>/icons" --inplace --id-prefix source --min-decoration-bytes 3000 --clean-stale
```
...
```bash
mkdir -p "skills/pptx-generator/templates/<kind_dir>/<template_id>"
```

> **Output location**: Templates go to `skills/pptx-generator/templates/<kind>/<template_id>/`. The generated directory name must match the final template ID used in the relevant index.
...
ls -la "skills/pptx-generator/templates/<kind_dir>/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 skills/pptx-generator/scripts/svg_quality_checker.py "skills/pptx-generator/templates/<kind_dir>/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
# For deck (default)
python3 skills/pptx-generator/scripts/register_template.py <template_id> --kind deck

# For layout
python3 skills/pptx-generator/scripts/register_template.py <template_id> --kind layout
```
...
>
> ```bash
> python3 skills/pptx-generator/scripts/register_template.py --kind deck --rebuild-all
> python3 skills/pptx-generator/scripts/register_template.py --kind layout --rebuild-all
> ```
