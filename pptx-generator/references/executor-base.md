...
```bash
ls skills/pptx-generator/templates/icons/chunk-filled/ | grep home
ls skills/pptx-generator/templates/icons/tabler-filled/ | grep home
ls skills/pptx-generator/templates/icons/tabler-outline/ | grep chart
ls skills/pptx-generator/templates/icons/phosphor-duotone/ | grep house
ls skills/pptx-generator/templates/icons/simple-icons/ | grep github
```
