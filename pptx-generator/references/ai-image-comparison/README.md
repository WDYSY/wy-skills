...
```bash
python3 skills/pptx-generator/scripts/image_gen.py \
    --manifest skills/pptx-generator/references/ai-image-comparison/rendering/_manifest.json \
    -o skills/pptx-generator/references/ai-image-comparison/rendering/ \
    --backend openai

python3 skills/pptx-generator/scripts/image_gen.py \
    --manifest skills/pptx-generator/references/ai-image-comparison/palette/_manifest.json \
    -o skills/pptx-generator/references/ai-image-comparison/palette/ \
    --backend openai

python3 skills/pptx-generator/scripts/image_gen.py \
    --manifest skills/pptx-generator/references/ai-image-comparison/type/_manifest.json \
    -o skills/pptx-generator/references/ai-image-comparison/type/ \
    --backend openai
```
